...
public class Main {
    ...
    public static void main( String[] args ) throws IOException {
        ...
        System.out.println();
        System.out.println(makeItalicJvmCommands(addFontCourierTagForUnicode(addFontCourierTagForSpecialWords(addFontCourierTagForClassFileStructure(inPlainText)))));
    }
}
